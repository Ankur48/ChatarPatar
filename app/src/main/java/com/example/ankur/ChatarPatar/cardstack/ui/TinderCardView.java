package com.example.ankur.ChatarPatar.cardstack.ui;
...
public class TinderCardView extends FrameLayout implements View.OnTouchListener {
    ...
    private void setUpImage(ImageView iv, UserModel user) {
        String avatarUrl = user.getProfileImageUri();
    ...
    private void setUpDisplayName(TextView tv, UserModel user) {
    ...
    private void setUpUsername(TextView tv, UserModel user) {
        String username = user.getStatus();
