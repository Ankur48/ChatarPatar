package com.example.ankur.ChatarPatar.viewholder;
...
import com.example.ankur.ChatarPatar.chat.ChatMessage;
...
public class FirebaseMessageViewHold extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public FirebaseMessageViewHold(View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void bindUser(final ChatMessage userModel) {
        ...
        if (userModel.getSender().equals("" + Constant.USER_ID)) {
            tvSenderView.setText(userModel.getMessage());
            ...
            tvReciverView.setText(userModel.getMessage());
        ...
        imgDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("imgDelete--->", "imgDelete....." + userModel.getMessage() + "getAdapterPosition();---" + getAdapterPosition() + "getItemId()---->" + getItemId());
            }
        });
